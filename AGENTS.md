...
results.tsv     — Flat experiment log: timestamp, method, trials, val_loss, accuracy, submission, notes
data/           — Raw CSVs, preprocessed .npy arrays, and generated submission CSVs — all per-competition files live here
```
